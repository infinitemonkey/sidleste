...
class m131203_164851_create_issue_user_and_assignment_tables extends CDbMigration
{
	public function up()
	{
	}
	...
	{
		echo "m131203_164851_create_issue_user_and_assignment_tables does not support migration down.\n";
		return false;
	}
